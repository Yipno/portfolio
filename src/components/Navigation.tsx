...
const Navigation = ({ activeSection }: { activeSection: SectionId }) => {
  return (
    <nav className='sticky top-0 w-full h-20 z-50 flex items-center justify-between border-x border-b border-border backdrop-blur-lg'>
      ...
      <div className='flex items-center'>
        <ul className='hidden md:flex md:flex-row justify-end items-center gap-4 px-4'>
          {navItems.map(item => {
