...
const Contact = () => {
  ...
  return (
    <div
      id='contact'
      className='pt-24 w-11/12 min-h-[calc(100vh-5rem)] flex flex-col items-center bg-bg'>
      <div>
        <p className='font-mono text-primary'>// Work together</p>
        <h2 className='font-title text-text text-6xl pb-4'>Contact</h2>
      </div>
      <div className='flex w-9/12 mt-8 gap-8'>
        <div className='w-2/5 h-140 flex px-1 flex-col justify-start gap-6'>
          ...
          <div className='border border-border w-full h-40 rounded-2xl flex'></div>
        </div>
        <form
          id='contact-form'
          onSubmit={handleSubmit}
          className='border border-border px-8 py-4 rounded-2xl w-3/5 flex flex-col items-start'>
          ...
          <button
            id='submit-button'
            type='submit'
            className='w-full h-14 mt-4 bg-primary text-bg font-medium px-6 py-3 rounded-full hover:cursor-pointer hover:bg-accent duration-300 ease-in-out'>
